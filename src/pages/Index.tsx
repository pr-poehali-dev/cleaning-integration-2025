...
const advantages = [
  ...
  { icon: "MapPin", title: "Выезд на дом", desc: "Приедем в удобное время — не нужно никуда везти мебель" },
];
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/5 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center cursor-pointer" onClick={() => scrollTo("hero")}>
            <img src="https://cdn.poehali.dev/projects/9b8e5809-3eed-40de-a586-aa4d126be120/bucket/fcd2a8fa-46fd-4e20-9d89-6c2a6b8c588d.png" alt="Аренда Чистоты" className="h-10 w-auto" style={{ filter: "brightness(0) invert(1)" }} />
          </div>
      ...
      <footer className="border-t border-white/8 py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center">
            <img src="https://cdn.poehali.dev/projects/9b8e5809-3eed-40de-a586-aa4d126be120/bucket/fcd2a8fa-46fd-4e20-9d89-6c2a6b8c588d.png" alt="Аренда Чистоты" className="h-8 w-auto" style={{ filter: "brightness(0) invert(1)" }} />
          </div>
